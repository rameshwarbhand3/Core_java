...
public class Client {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, SeatsNotAvailableException, UnknownShowException, InvalidSeatNumberException {
        ...
        List<Show> showList = dm.populateDataFromFile("/home/pranjal/Desktop/workspace/core-java/assignments/ShowBookingSystem/ShowDetails.ser");
        for (Show s : showList) {
...
//        try {
//            dm.bookShow(showList, showName, showTime, noOfSeats);
